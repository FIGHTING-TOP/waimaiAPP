 <template>
  <div class="page">
        ...
        <section class="activity_banner">
            <img src="../../../../../src/assets/img/activity.png">
        </section>
        <section class="invite_firend">
            <div class="invite_firend_style">
                <img src="../../../../../src/assets/img/weixin.png" @click="fenxiang">
                <p>邀请微信好友</p>
            </div>
            <div class="invite_firend_style">
                <img src="../../../../../src/assets/img/qq.png" @click="fenxiang">
                <p>邀请QQ好友</p>
            </div>
            <div class="invite_firend_style">
                <img src="../../../../../src/assets/img/fenxiang.png" @click="fenxiang">
                <p>面对面邀请</p>
            </div>
        </section>
        ...
        <section class="incom_tips">
            <img src="../../../../../src/assets/img/qianbao.png">
            <p>还不赶紧去邀请好友</p>
        </section>
