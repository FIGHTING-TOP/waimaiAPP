                    ...
                    <section class="hongbao_container">
                        <header class="hongbao_title">
                            ...
                            <section class="hongbao_description">
                                <img src="../../../../src/assets/img/description.png" height="24" width="24">
            ...
            <transition name="router-fade">
                <section v-if="categoryType === 2" class="voucher_container">
                    ...
                    <section class="unable_use">
                        <img src="../../../../src/assets/img/voucher.png" height="170" width="300">
                        <p>无法使用代金券</p>
                        <p>非客户端或客户端版本过低</p>
...
<style lang="scss" scoped>
    ...
    .hongbao_container{
        ...
        .hongbao_list_ul{
            .hongbao_list_li{
                background: #fff url(/src/assets/img/hongbao.png) repeat-x ;
